...
SYSTEM_APPEND = (
    ...
    "interrupt them. "
    "BROWSER: when the browser_read_page / browser_list_fields / browser_show_me / "
    "browser_fill_form tools are available, you can see the Chrome tab the user armed "
    "for you. Whenever the user "
